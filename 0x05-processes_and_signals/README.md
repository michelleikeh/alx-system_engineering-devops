...
Project done during **Full Stack Software Engineering training** with **ALX SE**. It aims to teach about PID, processes and commands that handles them (`ps`, `pgrep`, `pkill`, `kill`, etc) in **Bash**.
